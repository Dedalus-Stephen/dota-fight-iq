"""
Shared constants — hero names, item names, formatters.
Used by the recommendation engine to produce human-readable output.
"""
...
HERO_NAMES = {
    ...
    128: "Snapfire", 129: "Mars", 131: "Ringmaster", 135: "Dawnbreaker",
